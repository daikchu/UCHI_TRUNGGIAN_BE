...
CREATE TABLE IF NOT EXISTS contractHistoryInfor (
...
CREATE TABLE IF NOT EXISTS user_password_token (
  ...
  CONSTRAINT fk_user_password_token_user FOREIGN KEY (user_id) REFERENCES contractHistoryInfor (id)
);
...
CREATE TABLE IF NOT EXISTS user_roles (
  ...
  CONSTRAINT fk_user_roles_user FOREIGN KEY (user_id) REFERENCES contractHistoryInfor (id)
);
...
CREATE TABLE IF NOT EXISTS elected_officers (
  ...
  CONSTRAINT fk_elected_officers_user FOREIGN KEY (user_id) REFERENCES contractHistoryInfor (id)
);
...
CREATE TABLE IF NOT EXISTS selected_player (
  ...
  CONSTRAINT fk_selected_player_user FOREIGN KEY (user_id) REFERENCES contractHistoryInfor (id)
);